...
DEPLOY_ENV=prod
DEPLOY_HOST=pybr25-rondonit.tangrama.com.br
DEPLOY_PORT=22
DEPLOY_USER=plone
...
You need either a Ubuntu or Debian based system for pybr25-rondonit.tangrama.com.br, enable SSH, and install a supported version of Python 3 on that system.
...
cluster:
  hosts:
    pybr25-rondonit.tangrama.com.br:
      ansible_user: root
      ansible_host: pybr25-rondonit.tangrama.com.br
      host: pybr25-rondonit
      hostname: pybr25-rondonit.tangrama.com.br
      swarm_node:
        labels:
          type: manager
          env: production
...
Deploy the stack defined in `devops/stacks/pybr25-rondonit.tangrama.com.br.yml` to the remote server with:
