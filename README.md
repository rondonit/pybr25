...
- Accessible at [http://pybr25.localhost](http://pybr25.localhost) 🌐
...
- **backend**: Houses the API and Plone installation, utilizing pip instead of buildout, and includes a policy package named pybr25.core.
...
Generated using [Cookieplone (0.9.10)](https://github.com/plone/cookieplone) and [cookieplone-templates (7f26963)](https://github.com/plone/cookieplone-templates/commit/7f26963f52514a48bd4d39b788eb0359d95fbd83) on 2025-10-21 15:18:40.960596. A special thanks to all contributors and supporters!
