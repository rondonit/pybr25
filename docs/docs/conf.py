...
# Tutorial Python Brasil build configuration file
...
project = "Tutorial Python Brasil"
author = "rondonit"
...
linkcheck_ignore = [
    ...
    r"https://github.com/collective/tutorialpythonbrasil/issues/new",  # requires auth
...
html_theme_options = {
    ...
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/collective/tutorialpythonbrasil",
    ...
    "logo": {
        "text": "Tutorial Python Brasil",
    },
    "navigation_with_keys": True,
    "path_to_docs": "docs/docs",
    "repository_branch": "main",
    "repository_url": "https://github.com/collective/tutorialpythonbrasil",
...
# html_context = {
#     "edit_page_url_template": "https://github.com/collective/tutorialpythonbrasil/edit/main/docs/",
# }
...
ogp_site_name = "Tutorial Python Brasil Documentation"
ogp_type = "website"
...
htmlhelp_basename = "Tutorial Python BrasilDocumentation"
...
latex_documents = [
    (
        "index",
        "Tutorial Python BrasilDocumentation.tex",
        "Tutorial Python Brasil Documentation",
