...
myst:
  html_meta:
    ...
    "property=og:title": "Tutorial Python Brasil"
    "keywords": "Tutorial Python Brasil, documentation, A new project using Plone 6."
---

# Tutorial Python Brasil

Welcome to the documentation for Tutorial Python Brasil!
